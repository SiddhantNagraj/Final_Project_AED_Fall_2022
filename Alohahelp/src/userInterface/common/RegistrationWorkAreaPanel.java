...
import business.enterprisemainpkg.AlohaHelpEnterprise;
import business.enterprisemainpkg.HospitalEnterprise;
import business.enterprisemainpkg.SchoolEnterprise;
import business.networkpkg.Network;
import business.orgapkg.DoctorOrga;
import business.orgapkg.HelpSeekerOrga;
...
public class RegistrationWorkAreaPanel extends javax.swing.JPanel {
    ...
    private PersonDirect personDirectory;
...
////    }
    ...
    private void initComponents() {
        ...
        emailID1.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        createProfileButton.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        address1.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        address1.setText("Address Line1 : ");

        buttonGroup1.add(isHelpSeeker);
        isHelpSeeker.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        isVolunteer.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        helpSeekerNw.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        manageEnt.setText("Welcome to AlohaHelp !");
        ...
        isDoctorRadioBtn.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        volNetwork.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(manageEnt, javax.swing.GroupLayout.PREFERRED_SIZE, 445, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(442, 442, 442)
                .addComponent(createProfileButton, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
                 ...
                 JOptionPane.showMessageDialog(null, "Your age does not qualify as help seeker","warning", JOptionPane.WARNING_MESSAGE);
                  ...
                  JOptionPane.showMessageDialog(null, "HelpSeeker Organization does not exist for the enterprise! "+enterprise.getName(),"warning", JOptionPane.WARNING_MESSAGE);
                   return;      
                    ...
                    {
                     for(UserAc ua : e.getUserAccountDirectory().getUserAccountList())
                    {
                        ...
                        {
                        for(Orga o : e.getOrganizationDirectory().getOrganizationList())
                        {  
                         for(UserAc ua1 : o.getUserAccountDirectory().getUserAccountList())
                            {  
                    ...
                    UserAc userAccount = organization.getUserAccountDirectory().addUserAccount(userName, password, person, new HelpSeekerRole());
                  ...
                  for(Enterprise e : helpSeekerNw.getEnterpriseDirectory().getEnterpriseList())
                  {
                      if(e instanceof AlohaHelpEnterprise)
                      {
                       for(Orga organization : e.getOrganizationDirectory().getOrganizationList())
                       {
                 ...
                 JOptionPane.showMessageDialog(null, "Your age does not qualify as Volunteer","warning", JOptionPane.WARNING_MESSAGE);
                  ...
                  person.setVolunteer(true);
                   ...
                   String userName = SendEmailAndTextMessage.generateUserName(lastNameField.getText());
                    ...
                    System.out.println("In between"+userName+" "+password+emailIDField.getText());
                    boolean emailSent = SendEmailAndTextMessage.sendEmail(emailMsg, emailIDField.getText(),userName, password);
                  //  boolean emailSent = SendEmailAndTextMessage.sendEmail("test","revatilachyan@gmail.com" ,"Sushant", "Rajput");
                    ...
                    UserAc userAccount = organization.getUserAccountDirectory().addUserAccount(userName,password , person, new VolunteerRole());
                    userAccount.setPerson(person);
                ...
                if(isDoctorRadioBtn.isSelected() )
                {
                 ...
                 JOptionPane.showMessageDialog(null, "Your age does not qualify as Dcotor","warning", JOptionPane.WARNING_MESSAGE);
                  ...
                  person = organization.getPersonDirectory().addPerson();
                    ...
                    UserAc userAccount = organization.getUserAccountDirectory().addUserAccount(userName, password, person, new DoctorRole());
                    userAccount.setPerson(person);
                   ...
                   for(Enterprise e : n.getEnterpriseDirectory().getEnterpriseList())
                      {
                           ...
                           else if(e instanceof AlohaHelpEnterprise && isHelpSeeker.isSelected())
                           {
                             this.enterprise = e;
                              network = n;
                            }
    ...
    {
        System.out.println("Inside buildemail");
      StringBuilder emailMsgTxt = new StringBuilder();
        ...
        emailMsgTxt.append("AlohaHelp");
        System.out.println(emailMsgTxt.toString());
    ...
    public void getOrganization(String orgVal, Enterprise e){
     ...
     for (Orga organization : e.getOrganizationDirectory().getOrganizationList()){
       ...
       if(orgVal.equals("Volunteer") && organization instanceof VolunteerOrga)
        {
              this.organization = organization;
              this.personDirectory = organization.getPersonDirectory();
        
        }     
     else if(orgVal.equals("HelpSeeker") && organization instanceof HelpSeekerOrga)
             {
               this.organization = organization;
               this.personDirectory = organization.getPersonDirectory();
             }  
       
       else if(orgVal.equals("Doctor") && organization instanceof DoctorOrga)
             {
               this.organization = organization;
               this.personDirectory = organization.getPersonDirectory();
             } 
    ...
    emailIDField.setText("ramteke.s@northeastern.edu");
    emailIDField1.setText("ramteke.s@northeastern.edu");
