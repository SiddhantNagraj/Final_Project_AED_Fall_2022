...
public class ViewAnonymousRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewAnonymousRequestJPanel(JPanel userProcessContainer, UserAc account, VolunteerOrga organization, OrgaDirect directory) {
        initComponents();
    ...
    protected void paintComponent(Graphics g) {
     ...
     public void populateAnonymousHelpRequestTable(){
        ...
        for(WorkRequest request : volunteerOrganization.getworkQ().getWorkRequestList()){
    ...
    private void processHelpRquestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processHelpRquestJButtonActionPerformed
        ...
        NeedHelpWorkReq request = (NeedHelpWorkReq)anonymousHelpReqTable.getValueAt(selectedRow, 0);
