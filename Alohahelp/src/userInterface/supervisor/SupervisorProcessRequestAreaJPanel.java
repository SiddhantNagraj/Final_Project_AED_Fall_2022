...
public class SupervisorProcessRequestAreaJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        emailMsgTxt.append("ALOHAHELP");
            ...
            try {
                emailSent = SendEmailAndTextMessage.sendEmail(emailMsgTxt.toString(),emailId,userName, password);
            } catch (Exception ex) {
                Logger.getLogger(SupervisorProcessRequestAreaJPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
                    if(!emailSent)
                   {
