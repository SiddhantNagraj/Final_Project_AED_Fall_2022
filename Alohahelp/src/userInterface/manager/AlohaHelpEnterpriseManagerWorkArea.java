...
import business.workQpkg.DonationReq;
 ...
 * @author shiba
 */
public class AlohaHelpEnterpriseManagerWorkArea extends javax.swing.JPanel {
    private JPanel userProcessContainer;
   private  Enterprise enterprise;
   private EcoSystem ecoSystem;
   private UserAc userAccount;
   private VolunteerOrga vo;
    private DonorOrga do1 ;
    private HelpSeekerOrga hsOrg;
    private TransportOrga transOrg;
    private List<Entry<String, Integer>> topVolunteeerList;
     private List<Entry<String, Integer>> topDonorList;
    
    /**
     * Creates new form AlohaHelpEnterpriseManagerWorkArea
     */
    public AlohaHelpEnterpriseManagerWorkArea(JPanel userProcessContainer, Enterprise enterprise, EcoSystem ecoSystem, UserAc userAccount) {
        initComponents();
...
//    }
    ...
    private void initComponents() {
        ...
        manageEnt1.setText("AlohaHelp Manager Work Area");
        ...
        top3VolunteersBtn.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        totSenDevReqField.setBackground(new java.awt.Color(204, 204, 204));

        totTransReqField.setEditable(false);
        totTransReqField.setBackground(new java.awt.Color(204, 204, 204));

        totHelpReqField.setEditable(false);
        totHelpReqField.setBackground(new java.awt.Color(204, 204, 204));

        findTop3Donors.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        viewDetailedReportBtn.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        totSenDevReq1.setFont(new java.awt.Font("Malayalam MN", 1, 18)); // NOI18N
        totSenDevReq1.setText("Total Amount Donated By Donors");

        donatedAmntField.setEditable(false);
        donatedAmntField.setBackground(new java.awt.Color(204, 204, 204));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(manageEnt1, javax.swing.GroupLayout.PREFERRED_SIZE, 594, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(556, 556, 556))
        );
    ...
    private void viewDetailedReportBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailedReportBtnActionPerformed
      ...
      public void populateTextFields()
      {
          ...
          {
      if(do1!=null){
      totalDonorReq = String.valueOf(do1.getworkQ().getWorkRequestList().size());
              
        for(UserAc donorAccount : do1.getUserAccountDirectory().getUserAccountList())
      {
       if(!donorAccount.getWorkQueue().getWorkRequestList().isEmpty())
       {
         ...
         {  
           if(wrkrequest.getMessage().equalsIgnoreCase("Donated Money"))
             {
                 DonationReq donationRequest = (DonationReq)wrkrequest;
      ...
      if(vo!=null)
      {
          for(WorkRequest request : vo.getworkQ().getWorkRequestList())
          {
          ...
          for(UserAc userAccount : vo.getUserAccountDirectory().getUserAccountList())
          {
      ...
      if(transOrg!=null)
      {
           for(WorkRequest request : transOrg.getworkQ().getWorkRequestList())
          {
    ...
    public void populatePieChartData()
    {
       ...
       for(Orga organization : enterprise.getOrganizationDirectory().getOrganizationList())
       {
          ...
          {
          this.hsOrg = (HelpSeekerOrga)organization;   
    ...
    public void findTop3Volunteers()
    {
     ...
     HashMap<String, Integer> volMap = new HashMap<>(); 
      try
      {
     for(UserAc volunteerAccount : vo.getUserAccountDirectory().getUserAccountList())
      {
        if(!volunteerAccount.getWorkQueue().getWorkRequestList().isEmpty())
       {
         for(WorkRequest request : volunteerAccount.getWorkQueue().getWorkRequestList() )
         {
          ...
          {
              NeedHelpWorkReq nhwr = (NeedHelpWorkReq)request;  
        ...
        if(!donorAccount.getWorkQueue().getWorkRequestList().isEmpty())
       {
        ...
        for(WorkRequest wrkrequest : donorAccount.getWorkQueue().getWorkRequestList() )
         {  
           ...
           {
               NeedSensorDWorkReq nsdwr = (NeedSensorDWorkReq)wrkrequest;
               if(nsdwr.getdonationReqResult().equalsIgnoreCase(SupervisorWorkRequest.REQUEST_ACCEPT))
               {
               ++noOfRequests; 
               }
           }
