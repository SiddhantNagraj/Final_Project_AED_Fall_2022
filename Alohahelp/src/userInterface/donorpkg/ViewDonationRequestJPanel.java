...
public class ViewDonationRequestJPanel extends javax.swing.JPanel {
    ...
    private DonorOrga donorOrganization;
    /**
     * Creates new form ViewDonationRequestJPanel
     */
    public ViewDonationRequestJPanel(JPanel userProcessContainer, UserAc userAccount, Orga organization, EcoSystem ecoSystem) {
        initComponents();
         this.userProcessContainer = userProcessContainer;
        this.ecoSystem = ecoSystem;
        this.userAccount = userAccount;
        this.donorOrganization = (DonorOrga)organization;
      ...
      public void populateDonationWorkRequestTable()
    {
        ...
        for(WorkRequest request : donorOrganization.getworkQ().getWorkRequestList())
        {
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        NeedSensorDWorkReq request = (NeedSensorDWorkReq)workRequestJTable.getValueAt(selectedRow, 0);
        if(request.getReceiver() == null)
        {
