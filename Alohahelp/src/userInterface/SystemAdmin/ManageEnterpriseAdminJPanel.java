    ...
    private void populateEnterpriseUserTable() {
        ...
        for (Network network : system.getNetworkList()) {
            for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                for (UserAc userAccount : enterprise.getUserAccountDirectory().getUserAccountList()) {
       ...
       for(Network network1 : system.getNetworkList())
        {
          ...
          {
              for(UserAc ua : enterprise1.getUserAccountDirectory().getUserAccountList())
              {
...
//        }
        ...
        person.setName();
        UserAc account = enterprise.getUserAccountDirectory().addUserAccount(username, password, person, new AdminRole());
    ...
    private void deleteNetworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteNetworkActionPerformed
        UserAc userAccountToBeDeleted = null;
        ...
        if(selectedRow >= 0)
        {
            ...
            if(dialogResult == JOptionPane.YES_OPTION)
            {
                ...
                UserAc userAccount = (UserAc)enterpriseUserJTable.getValueAt(selectedRow, 2);
                String entName = (String)enterpriseUserJTable.getValueAt(selectedRow, 0);
                for (Network network : system.getNetworkList()) {
                    for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                     if(entName.equals(enterprise.getName()))
                     {
                       for (UserAc ua : enterprise.getUserAccountDirectory().getUserAccountList()) {
