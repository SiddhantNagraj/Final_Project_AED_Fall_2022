...
import business.orgapkg.MayorOrga;
...
public class MayorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private MayorOrga mayorOrganization;
    private HashMap<String,Integer> communitydetailsmap;
 //   private HelpSeekerOrga helpSeekerOrg;

    /**
     * Creates new form SupervisorWorkAreaJPanel
     */
    public MayorWorkAreaJPanel(JPanel userProcessContainer, UserAc userAccount, Orga organization, EcoSystem ecoSystem ) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.ecoSystem = ecoSystem;
        this.userAccount = userAccount;
        this.mayorOrganization = (MayorOrga)organization;
    ...
    public HelpSeekerOrga getHelpSeekerOrg()
    {
        HelpSeekerOrga helpSeekerOrg = null;
        ...
        for(Network network : ecoSystem.getNetworkList())
        {
         if(network.equals(userAccount.getNetwork()))
         {
          for(Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList())
          {
            ...
            {
             if(organization instanceof HelpSeekerOrga)
             {
              helpSeekerOrg = (HelpSeekerOrga)organization; 
             }
            }
            }
          }
    ...
    public HashMap<String,Integer> getHelpSeekerData()
    {
        ...
        HelpSeekerOrga helpSeekerOrganization = getHelpSeekerOrg();
