...
public class HelpSeekerWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public HelpSeekerWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise , UserAc userAccount, EcoSystem ecoSystem) {
        initComponents();
       ...
       for(WorkRequest request : userAccount.getWorkQueue().getWorkRequestList())
        {
            ...
            if(count<5)
            {
            DatatoDoctorWorkReq dataToDoctorWorkRequest = (DatatoDoctorWorkReq)request;
            ...
            if(count<5)
            {
             NeedSensorDWorkReq needSensorDeviceWorkRequest = (NeedSensorDWorkReq)request;
             sb= new StringBuilder();
             sb.append("RequestResult: ");
             sb.append(needSensorDeviceWorkRequest.getdonationReqResult());
